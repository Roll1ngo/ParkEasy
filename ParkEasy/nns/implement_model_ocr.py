...
def extract_license_plate_text(image_path):
    ...
    print("__________________________________________________________", result)
...
def segment_characters(image):
    ...
    cv2.imwrite('ParkEasy/nns/test_images/ocr/output_img.jpg', img_binary_lp)
...
def find_contours(dimensions, img):
    ...
    ii = cv2.imread('ParkEasy/nns/test_images/ocr/output_img.jpg')
...
source_image_path = 'ParkEasy/nns/test_images/monako (1).jpg'
plate_path = get_plate_number_image(source_image_path)
plate = cv2.imread(plate_path)
char = segment_characters(plate)
extract_license_plate_text("ParkEasy/nns/test_images/ocr/output_img.jpg")
